...
import { getWalletExchange } from "@/app/utils/api";
											...
											<div className="flex flex-col space-y-3 p-4">
												...
												<div className="flex items-center justify-between space-x-2">
													<div className="flex items-center space-x-2.5">
														...
														<div
															data-testid="swap-from-asset-selector"
															role="button"
															className="outline-0 cursor-pointer"
															tabIndex={0}
														>
											...
											<div className="flex flex-col space-y-3 p-4">
												...
												<div className="flex items-center justify-between space-x-2">
													<div className="flex items-center space-x-2.5">
														...
														>
															<button
																data-testid="swap-to-asset-selector-empty"
																type="button"
																className="outline-none bg-primary-opacity-1 text-primary-default hover:bg-primary-opacity-2 active:bg-primary-opacity-3 disabled:bg-primary-opacity-1 p-2.5 icon-circle-button"
															>
																<svg
