...
const NavButton = ({ icon, label, link, activeIcon }: NavButtonProps) => {
...
export default function WalletLayout({
	...
	const isEarnWithSlugPage = /^\/wallet\/earn\/[^/]+$/.test(pathname);
	...
	return (
		<>
			...
			{!isEarnWithSlugPage &&
				...
				!isSendPage &&
				!isReceivePage && (
					<div className="flex flex-col dark:bg-[#1b1b1c] z-[99] bg-white fixed bottom-0 left-0 right-0">
