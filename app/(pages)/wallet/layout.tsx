			...
			<div className="flex flex-col bg-[#1b1b1c] z-[10]">
				<div className="flex items-center z-10 flex-shrink-0 self-center w-full justify-between h-[72px] px-6 border-t border-utility-1-opacity-5 md:max-w-[438px]">
					<div
						...
						className="flex flex-col w-16 py-2 text-center items-center"
						role="button"
					>
						<span className="flex justify-center mb-0.5">
							...
							>
								...
								></path>
								<rect
									className="text-primary-opacity-3"
									width="6"
									height="8"
						...
						<small className="typography-caption-12 text-primary-default font-medium   text-unset  ">
							Home
						</small>
					</div>
					<div
					...
					>
						...
						<small className="typography-caption-12 text-utility-1-default font-medium   text-unset  ">
							Earn
						</small>
					</div>
					<div
